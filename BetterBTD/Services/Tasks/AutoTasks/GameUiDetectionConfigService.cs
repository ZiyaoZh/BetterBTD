    ...
    private static GameUiDetectionConfig CreateDefaultConfig()
    {
        return new GameUiDetectionConfig
        {
            ...
            [
                ...
                CreateRule("odyssey_settlement", "Odyssey settlement", GameUiStateId.OdysseySettlement, 611,
                    Eq(330, 500, "#CBA774"), Eq(1360, 350, "#B4874F"), Eq(1360, 650, "#B4874F"), Eq(1070, 300, "#CF2C0C"), Eq(1450, 300, "#CF2C0C")),
                CreateRule("odyssey_stage_victory", "Odyssey stage victory", GameUiStateId.OdysseyStageVictory, 610,
                    Eq(560, 190, "#FFFFFF"), Eq(1220, 145, "#FFFFFF"), Eq(950, 780, "#DCC3A8")),
                CreateRule("odyssey_reward", "Odyssey reward", GameUiStateId.OdysseyReward, 609,
                ...
                CreateRule("chest_opened", "宝箱已开启界面", GameUiStateId.ChestOpened, 600,
                    Eq(960, 180, "#121417"), Eq(750, 60, "#121417"), Eq(500, 240, "#121417"), Eq(1130, 200, "#121417"), Eq(1725, 500, "#121417"), Eq(884, 1000, "#67E400"), Eq(1037, 1000, "#67E400")),
                CreateRule("two_chests", "两个宝箱界面", GameUiStateId.TwoChests, 590,
                    Eq(960, 180, "#121417"), Eq(750, 60, "#121417"), Eq(500, 240, "#121417"), Eq(1130, 200, "#121417"), Eq(1725, 500, "#121417"), Ne(828, 600, "#121417"), Ne(1130, 600, "#121417")),
                CreateRule("three_chests", "三个宝箱界面", GameUiStateId.ThreeChests, 589,
                    Eq(960, 180, "#121417"), Eq(750, 60, "#121417"), Eq(500, 240, "#121417"), Eq(1130, 200, "#121417"), Eq(1725, 500, "#121417"), Ne(660, 600, "#121417"), Ne(1260, 600, "#121417")),
