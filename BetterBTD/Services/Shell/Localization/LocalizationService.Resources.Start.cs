...
public sealed partial class LocalizationService
{
    private static Dictionary<string, string> BuildZhCnStartResources() => new(StringComparer.OrdinalIgnoreCase)
    {
        ...
        ["Start.Browse"] = "浏览",
        ["Start.DesktopCloneTitle"] = "桌面分身",
        ["Start.DesktopCloneDescription"] = "在独立 Windows Child Session 中运行 BTD6 和 BetterBTD，主桌面不会被游戏输入占用。",
        ["Start.StartDesktopClone"] = "启动桌面分身",
        ["Start.LogoffDesktopClone"] = "注销分身",
        ["Start.DesktopCloneUnavailable"] = "桌面分身服务不可用。",
        ["Start.DesktopCloneStartFailed"] = "启动桌面分身失败",
        ["Start.DesktopCloneLogoffFailed"] = "注销桌面分身失败",
    ...
    private static Dictionary<string, string> BuildEnUsStartResources() => new(StringComparer.OrdinalIgnoreCase)
    {
        ...
        ["Start.Browse"] = "Browse",
        ["Start.DesktopCloneTitle"] = "Desktop Clone",
        ["Start.DesktopCloneDescription"] = "Run BTD6 and BetterBTD in an isolated Windows Child Session so the primary desktop does not receive game input.",
        ["Start.StartDesktopClone"] = "Start Desktop Clone",
        ["Start.LogoffDesktopClone"] = "Log Off Clone",
        ["Start.DesktopCloneUnavailable"] = "Desktop clone service is unavailable.",
        ["Start.DesktopCloneStartFailed"] = "Desktop clone startup failed",
        ["Start.DesktopCloneLogoffFailed"] = "Desktop clone logoff failed",
