...
public partial class TaskRuntimeWindow : FluentWindow
{
    private const int HotkeyIdBase = 0xC10;
    ...
    public TaskRuntimeWindow(TaskRuntimeWindowViewModel viewModel)
    {
    ...
    {
        if (DataContext is TaskRuntimeWindowViewModel viewModel)
        {
    ...
    {
        if (!string.Equals(e.PropertyName, nameof(TaskRuntimeWindowViewModel.FocusedStep), StringComparison.Ordinal))
        {
            return;
        }

        if (sender is not TaskRuntimeWindowViewModel viewModel)
        {
            return;
        }
    ...
    {
        if (DataContext is not TaskRuntimeWindowViewModel viewModel)
        {
            return;
        }
