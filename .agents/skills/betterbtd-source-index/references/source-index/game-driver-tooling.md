...
| `tools/BetterBTD.GameDriver/betterbtd_game_driver` | 15 |
| `tools/BetterBTD.GameDriver/navigation` | 1 |
| `tools/BetterBTD.GameDriver/tests` | 12 |
...
| [cli.py](../../../../../tools/BetterBTD.GameDriver/betterbtd_game_driver/cli.py) | External black-box tool implementation or test; primary symbols: error, create_parser, _add_interaction_arguments, _add_navigation_arguments, parse_args |
...
| [navigation.py](../../../../../tools/BetterBTD.GameDriver/betterbtd_game_driver/navigation.py) | External black-box tool implementation or test; primary symbols: resolve_element, find_route, edge_for, is_safe, click |
...
### `tools/BetterBTD.GameDriver/navigation`

| File | Description |
| --- | --- |
| [page-navigation.json](../../../../../tools/BetterBTD.GameDriver/navigation/page-navigation.json) | External tool scenario, schema, catalog, or test data |
...
| [test_cli.py](../../../../../tools/BetterBTD.GameDriver/tests/test_cli.py) | External black-box tool implementation or test; primary symbols: test_no_arguments_selects_help, test_navigate_derives_target_page_from_parameters, test_navigate_rejects_mode_without_difficulty, test_capture_defaults_to_real_btd6_window_titles_and_processes, test_explicit_process_name_does_not_apply_default_title_filter |
...
| [test_navigation.py](../../../../../tools/BetterBTD.GameDriver/tests/test_navigation.py) | External black-box tool implementation or test; primary symbols: setUpClass, test_verified_route_uses_one_cross_page_edge_at_a_time, test_target_difficulty_filters_candidate_routes, test_unsupported_parameterized_mode_does_not_fall_back_to_easy, test_unverified_edge_is_rejected |
